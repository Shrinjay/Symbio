...
export class SponsorService {
  ...
  getSponsors(params): Observable<Sponsor[]> {
    return this.http.get<Sponsor[]>('http://localhost:8080/api/sponsors/', {params: params})
  }

  getSponsorNum(params): Observable<Number> {
    return this.http.get<Number>('http://localhost:8080/api/sponsors/numsponsors/', {params: params})
  }
